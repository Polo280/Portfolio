const Contact = () => {
  const social_links = [
    ...
    {
      href: "https://www.linkedin.com/in/jorglezd/",
      icon: (
        <svg
          width="35"
          height="35"
  ...
  return (
    <section id="contact">
      <div className="flex w-full flex-row bg-black lg:px-[100px] lg:pt-[20px] lg:pb-[100px]">
        {/* Socials and text */}
        <div className="flex w-full flex-col gap-[10px]">
          <h2 className="mt-[50px] w-full text-[35px] text-white">
            Get in touch
          </h2>
          <p className="max-w-[500px] text-[17px] leading-loose text-zinc-400">
            I'd love to hear from you. Got an idea or suggestion? <br /> Feel free
            to reach out!
          </p>
          <div className="mt-[20px] flex flex-row gap-[20px]">
            {social_links.map(({ href, icon}, key) => (
              <a
        ...
        <div className="flex w-full pt-[50px]">
          <form action="https://getform.io/f/aroozgnb" method="POST" className="flex w-full flex-col gap-[30px]">
            <div className="flex w-full flex-row gap-[30px]">
              {/* Name */}
              <div className="flex w-full flex-col gap-[15px]">
                <p className="px-[5px] text-white">Name</p>
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-zinc-800 px-3 py-3 text-sm text-zinc-200 outline-none ring-1 ring-inset ring-transparent transition-shadow hover:ring-zinc-50/5 focus:ring-2 focus:ring-emerald-500"
                />
              </div>

              {/* Email */}
              <div className="flex w-full flex-col gap-[15px]">
                <p className="px-[5px] text-white">Email</p>
                <input
                  type="text"
                  name=""
                  id="email"
            ...
            <div className="flex w-full flex-col gap-[15px]">
              <p className="px-[5px] text-zinc-200">Message</p>
              <textarea
                name="message"
                id="message"
                placeholder="Let your imagination flow ..."
                required
                className="max-h-[300px] min-h-[180px] w-full resize-y rounded-xl bg-zinc-800 px-3 py-3 text-sm text-zinc-200 outline-none ring-1 ring-inset ring-transparent transition-shadow hover:ring-zinc-50/5 focus:ring-2 focus:ring-emerald-500"
              >
              </textarea>
            </div>

            <button className="mt-[5px] w-full rounded-2xl bg-emerald-950 py-[10px] text-[20px]
            text-emerald-300 transition-colors ring-1 ring-inset ring-zinc-400 hover:bg-emerald-500 hover:text-white duration-300">
              Submit Form
            </button>
          </form>
        </div>
