  ...
  return (
    ...
    <div className="fixed top-0 left-0 z-50 flex h-[70px] w-full flex-row justify-between bg-zinc-900 ring-1 ring-[#3f4346] ring-offset-0 px-10">
      ...
      <nav className="flex flex-row items-center justify-center text-white gap-10 text-[17px]">
          <a href="#home" className="hover:underline hover:text-emerald-300">Home</a>
          <a href="#about" className="hover:underline hover:text-emerald-300">About</a>
          <a href="#projects" className="hover:underline hover:text-emerald-300">Projects</a>
          <a href="#contact" className="hover:underline hover:text-emerald-300">Contact</a>
